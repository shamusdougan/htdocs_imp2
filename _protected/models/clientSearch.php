...
class ClientSearch extends Client
{
    ...
    {
        return [
            [['id', 'state', 'postcode', 'phone1', 'phone2', 'ABN', 'agreement_id', 'accountBillTo', 'FK1', 'FK2', 'FK3', 'FK4', 'FK5', 'sync_status', 'contact_billing', 'contact_authorized', 'contact_owner'], 'integer'],
